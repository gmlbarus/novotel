...
$(document).ready(function(){
	...
	$("#flex1").flexigrid
			(
			{
			url: 'isi/kontrol/data-laundry.php',
			dataType: 'json',
			colModel : [
				{display: 'ID', name : 'id', width : 20, sortable : true, align: 'center'},
				{display: 'Nama', name : 'nama', width : 85, sortable : true, align: 'center'},
				{display: 'No Kamar', name : 'no_kamar', width : 150, sortable : true, align: 'center'},
				{display: 'Telepon', name : 'telepon', width : 160, sortable : true, align: 'center'},
				{display: 'Paket', name : 'paket', width : 120, sortable : true, align: 'center'},
...
*/
			...
			searchitems : [
				...
				{display: 'No Kamar', name : 'no_kamar'},
				{display: 'Telepon', name : 'alamat'},
				{display: 'Paket', name : 'poin'},
