...
$sql = "SELECT * FROM kamar $where $sort $limit";
$result = runSQL($sql);

$total = countRec('id_kamar','kamar',$where);
...
while ($row = mysql_fetch_array($result)) {
	if ($rc) $json .= ",";
		$json .= "\n{";
		$json .= "id:'".$row[0]."',";
		$json .= "cell:['".$r++."','".$row[0]."' , '<img src=".'../asset/images/kamar/'.$row[0].'.jpg'." width=".'80'.">',";
